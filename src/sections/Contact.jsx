...
export default function Contact() {
  ...
  const validateForm = () => {
    ...
    if (formData.budget && !/^\d+$/.test(formData.budget.trim())) {
      newErrors.budget = "Budget must be numbers only";
    }
...
src={Astra}
alt="Contact"
className="w-72 md:w-[420px] rounded-2xl shadow-lg object-cover"
animate={{ y: [0, 10, 0] }}
...
<option value="AWS Cloud Solutions" className="text-black">
AWS Cloud Solutions
</option>

<option value="IT Infrastructure Setup" className="text-black">
