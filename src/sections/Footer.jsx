...
const glowVariants = {
  ...
  hover : {
    scale : [ 1 , 1.2 , 1 , 1.3 ],
    filter : "drop-shadow(0 0 8px rgba(13,88,204,0.9)) drop-shadow(0 18px rgba(36,185,129,0.8))",
...
<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(36,185,129,0.30),transparent_70%)]"/>
...
<p className="text-gray-300 italic max-w-xl">
  “Success is when preparation meets opportunity. Dont wait for it, create it.”
</p>

<p className="text-xs text-gray-400">
  &copy; {new Date().getFullYear()} Ujwal Shet. All rights reserved.
</p>
